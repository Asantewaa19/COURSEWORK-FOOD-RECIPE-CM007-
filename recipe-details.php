...
<head>
    ...
    <!-- Title -->
    <title>Benjor's Kitchen Recipes | Receipe Details</title>
                    ...
                    <div class="col-12 col-md-8">
                        <div class="receipe-headline my-5">
                            ...
                            <div class="receipe-duration">
                                <h6>Preperation time: <?php  echo $row['recipePrepTime'];?> mins</h6>
                                <h6>Cook Time: <?php  echo $row['recipeCookTime'];?> mins</h6>
